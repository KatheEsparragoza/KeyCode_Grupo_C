...
const tratamientoscapilares = [
  ...
  },
  {
    ...
    price: '$35.000',
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaPN5XiPbj0sHDCdG8WTEX8e4-OP-6B3uTrQ&s',
  },
  {
    id: 3,
    ...
    price: '$40.000',
    imageUrl: 'https://example.com/reparador.jpg',
  },
  {
    id: 4,
    ...
    price: '$32.000',
    imageUrl: 'https://example.com/nutritivo.jpg',
  },
  {
    id: 5,
    ...
    price: '$28.000',
    imageUrl: 'https://example.com/suavizante.jpg',
  },
  {
    id: 6,
    ...
    price: '$33.000',
    imageUrl: 'https://example.com/antifrizz.jpg',
  },
  {
    id: 7,
    ...
    price: '$45.000',
    imageUrl: 'https://example.com/organico.jpg',
  },
];
    ...
    <div className="min-h-screen p-8 bg-gradient-to-r">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {tratamientoscapilares.map((tratamiento) => (
          <div
            key={tratamiento.id}
            className="border p-4 rounded-lg shadow-lg bg-gradient-to-r from-pink-200 to-pink-400"
          >
            <img
              src={tratamiento.imageUrl}
              alt={tratamiento.name}
              className="w-full h-48 object-cover rounded-lg mb-4 max-w-full" // Limitar ancho
            />
            ...
            <p className="text-pink-800 font-bold text-lg">{tratamiento.price}</p> {/* Color rosado para el precio */}
            <NavLink to="/CartShop">
